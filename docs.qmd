...
format: 
  revealjs:
    logo: input/images/banner_nudos.jpg
    slide-number: true
    theme: [pp.scss]
...
![](input/images/banner_nudos.jpg){width="80%" fig-align="center"}

![](input/images/lineas-nudos.png)
...
## **¿Cómo la composición de género del establecimiento y las actitudes hacia las tecnologías afectan las expectativas de autoeficacia sobre las tecnologías de los hombres y las mujeres estudiantes de octavo básico en Chile?** {data-background-color="#5f5758"}
...
::: {style="text-align: center;"}
![](input/images/multilevel_diagram.png){width="90%"}
:::
...
::: aside
-   c_f_ratio_grade = Proporción femenina
...
interactions::interact_plot(m2_speceff, pred = s_sex, modx = c_f_ratio_grade,
                            ...
                            modx.labels = c("+1 SD (68%)","Media (50%)","-1 SD (42%)"))+
...
![](input/images/s_ictfut.png)

#### Valoración social positiva

![](input/images/s_ictpos.png)

#### Valoración social negativa

![](input/images/s_ictneg.png)
:::
