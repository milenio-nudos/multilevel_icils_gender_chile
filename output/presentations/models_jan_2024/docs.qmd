...
-   Varianza explicada pequeña.
-   Ser mujer y tener puntaje alto disminuye autoeficacia especializada. A nivel individual y agregado.
-   Aunque no significativo, las mujeres, en promedio, tienen una relación más negativa entre alfabetización computacional y autoeficacia especializada que los hombres (interacción).
-   Control de promedio agregado CIL modifica efecto de composición de género.
