...
author: Juan Carlos Castillo, Daniel Miranda & Nicolás Tobar
...
#| tbl-cap: "Estadísticos descriptivos por nivel"
#| tbl-subcap: 
#| - "Nivel estudiante"
#| - "Nivel escuela"
#| layout-ncol: 2
...
## Autoeficacia
-   Los ítems se distribuyen relativamente igual entre ambas dimensiones. Los niveles de autoeficacia en tareas generales son mayores.
-   Se hizo un análisis factorial confirmatorio que sugirió 2 factores. Se ajusta con lo propuesto por ICILS.
```{r}
#| label: fig-efficacy-distribution
#| fig-cap: "Distribución de frecuencias"
#| fig-subcap: 
...
## Interacción Sexo-CIL {.smaller}
-   Se hallaron interacciones significativas en autoeficacia básica.
```{r}
